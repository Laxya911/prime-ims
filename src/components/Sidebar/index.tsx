...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  if (session.status === "authenticated" && session.data && session.data.user) {
    return (
      <aside
        ref={sidebar}
        className={`absolute left-0 top-0 z-9999 flex h-screen w-62.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark xlg:static xlg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-3.5 lg:py-4.5">
          <Link href="/">
            <Image
              ...
              height={36}
              aria-label="Logo"
              src={companyData?.logo || "/images/logo/logo.svg"}
              alt="Logo"
              priority
          ...
          <button
            ...
            className="block xlg:hidden text-bodydark2"
          >
            <FaArrowLeft />
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-3 py-2 px-4 lg:px-6">
            {/* <!-- Menu Group --> */}
            <>
              <ul className="mb-2 flex flex-col gap-1.5">
                          ...
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              <Link
                                href="/products/view"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/invoice/view" && "text-white"
                                }`}
                              >
                                View Products
                              </Link>
                          ...
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            ...
                            <li>
                              <Link
                                href="/purchase/view"
                                className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                  pathname === "/purchase/view" && "text-white"
                                }`}
                              >
                                View Purchases
                              </Link>
                ...
                <SidebarLinkGroup
                  activeCondition={
                    pathname === "/quotation" || pathname.includes("quotation")
                  }
                >
                  {(handleClick, open) => {
                    return (
